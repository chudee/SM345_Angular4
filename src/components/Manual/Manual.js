    ...
    return (
        <div>
            ...
            <Typography type="body1">
                <br />
                - 1차 보고서 이후 1차장학금(10만원)을 지급한다.
                <br />
                - 2차 보고서 이후 활동한 내역, 인증샷 등을 참고하여 2차 장학금(15만원)을 지급한다.
                <br />
            ...
            <Typography type="body1">
                <br />
                - C언어, java, 이산수학, 데이터베이스 개론 등 과목을 주제로 하는 멘토링은 멘티의 해당 과목의 평균 성적이  B+ 이상이어야 한다.
                <br />
                - 그 외 주제(html, css, 문서실무, 보안 등)는 포트폴리오를 제작해야 한다.
                <br />
                (이 때 포트폴리오는 학습 주제에 맞는 활동 자료 모음집을 의미한다.)
            </Typography>
            ...
            <Typography type="body1">
                <br />
                - 멘토가 팀별 주제를 계획한 것을 계획서에 적어 증명자료와 함께 제출한다.
                <br />
            ...
            <Typography type="body1">
                <br />
                1. C언어, 이산수학, java, 데이터베이스개론의 경우 해당 과목 성적이 B+ 이상이어야 한다.
                <br />
            ...
            <Typography type="body1">
                <br />
                - 1학년 : 이산수학, C프로그래밍, 문서작성(PPT 등), 보안, html
                <br />
